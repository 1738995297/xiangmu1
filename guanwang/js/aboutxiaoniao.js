...
$(function(){
	...
	doWelcomeAnimate();
	$('#welcomeIconimg').load(function(){
		//对于可以识别img.load的浏览器，先清除以前的定时器，重新开启定时器。
		clearInterval(GLOBLE.welcomeAnimateTimer);
		doWelcomeAnimate();
	});
	...
	$(".yunmove_btn_right").click(function(){
		...
		$(this).find(".yunmove_btn").addClass("now");
